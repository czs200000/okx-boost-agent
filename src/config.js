...
export const config = Object.freeze({
  ...
  maker: {
    ...
    trendMultiTfEnabled: bool("MAKER_TREND_MULTI_TF_ENABLED", true),
    trendMultiTfIntervalMs: number("MAKER_TREND_MULTI_TF_INTERVAL_MS", 600000),
    flowAllocEnabled: bool("MAKER_FLOW_ALLOC_ENABLED", true),
    flowAllocIntervalMs: number("MAKER_FLOW_ALLOC_INTERVAL_MS", 21600000),
    flowAllocFloorPct: number("MAKER_FLOW_ALLOC_FLOOR_PCT", 25),
    flowAllocCapPct: number("MAKER_FLOW_ALLOC_CAP_PCT", 60),
    structureAnchorEnabled: bool("MAKER_STRUCTURE_ANCHOR_ENABLED", true),
    structureAnchorFactor: number("MAKER_STRUCTURE_ANCHOR_FACTOR", 0.3),
    ...
    gridLadderMax: number("MAKER_GRID_LADDER_MAX", 2),
    // Use the same conservative execution-cost assumption as the xStock
    // backtests. X Layer gas is sponsored, but DEX routing/slippage is not.
    gridFeeRate: number("MAKER_GRID_FEE_RATE", 0.0008),
    gridGasUsd: number("MAKER_GRID_GAS_USD", 0),
    gridBuySlippagePct: number("MAKER_GRID_BUY_SLIPPAGE_PCT", 0.25),
    gridSellSlippagePct: number("MAKER_GRID_SELL_SLIPPAGE_PCT", 0.25),
    extraGridToken: process.env.MAKER_GRID_EXTRA_TOKEN || "",
    extraGridAddress: process.env.MAKER_GRID_EXTRA_ADDRESS || "",
    extraGridEnabled: bool("MAKER_GRID_EXTRA_ENABLED", true),
    ...
    extraGridSellSlippagePct: number("MAKER_GRID_EXTRA_SELL_SLIPPAGE_PCT", 0.20),
